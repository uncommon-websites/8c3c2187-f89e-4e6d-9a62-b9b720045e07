		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-20">
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					<li><a href="mailto:hello@hologram.io" class="hover:text-foreground">hello@hologram.io</a></li>
				</ul>
			</div>

			<!-- Products -->
			<div>
				<h4 class="font-mono text-xs uppercase text-muted mb-4">Platform</h4>
				<ul class="space-y-2 text-xs font-mono text-muted">
					<li><a href="#" class="hover:text-foreground">Virtual Compute</a></li>
					<li><a href="#" class="hover:text-foreground">Atlas Framework</a></li>
					<li><a href="#" class="hover:text-foreground">Enterprise License</a></li>
					<li><a href="#" class="hover:text-foreground">Free Tier</a></li>
					<li><a href="#" class="hover:text-foreground">Pay-Per-Use</a></li>
					<li><a href="#" class="hover:text-foreground">Managed Hosting</a></li>
				</ul>
			</div>
			...
			<div>
				...
				<ul class="space-y-2 text-xs font-mono text-muted">
					...
					<li><a href="#" class="hover:text-foreground">Technical Papers</a></li>
